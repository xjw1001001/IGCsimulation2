# -*- coding: utf-8 -*-
"""
Created on Mon Oct 09 09:36:46 2017
...
def main(args):
    ...
    tree_loc = folder_loc + '/MR_GR_separate_forPAML.newick'#TODO:

    #tau_list =[0.0]#[0.0,0.1,0.7, 1.0, 0.4079238, 3.0,6.0,10.0, 20.0]#TODO: [0.0]*[3.0,10.0] run
    tau_list = [args.tau]#[0.0,0.1,0.7, 0.5,1.0, 0.1630137]
    IGC_geo_list = [3.0,10.0,50.0, 100.0, 500.0]
    #IGC_geo_list = [10.0]
    name_tree_1st = folder_loc +'/MR_GR_separate_forPAML_1st.newick'#TODO:
    name_tree_2nd = folder_loc +'/MR_GR_separate_forPAML_2nd.newick'#TODO:
    ...
    for IGC_geo in IGC_geo_list:
        for tau in tau_list: 
            ...
            for sim_num in range(30):#['/Users/xjw1001001/Desktop/PAML/codeml.exe', './tau_1.409408geo_50.0_Sim_16_codeml.ctl']
                ...
                wk_dir = folder_loc +'/PAMLresult/MR_GR/tau'+str(tau)+'/IGCgeo_' + str(IGC_geo) + '/sim_' + str(sim_num) + '/'#TODO:
                if not os.path.isdir(wk_dir):
                    os.makedirs(wk_dir)                                                                  
                seq_loc = folder_loc +'/' + 'MR_GR/tau'+str(tau)+'/IGCgeo_' + str(IGC_geo) + '/sim_' + str(sim_num) + '/' + 'MR_GR_MG94_'+ 'geo_' + str(IGC_geo) + '_Sim_' + str(sim_num) + '_leaf.fasta'#TODO:
                ...
                if os.path.isfile(out_tree2_file):
                    ...
                    with open(out_tree2_file, 'r') as f:
                        all_lines = f.readlines()
                    tree_line = [i for i in all_lines if i[:12] == '(Aplysia_cal'][0]#TODO:
